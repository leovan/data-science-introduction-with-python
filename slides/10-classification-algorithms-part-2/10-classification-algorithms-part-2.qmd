...
::: aside
<https://scikit-learn.org/stable/modules/tmp/sklearn.ensemble.RandomForestClassifier.html>
:::
...
::: aside
<https://scikit-learn.org/stable/modules/tmp/sklearn.ensemble.GradientBoostingClassifier.html>
:::
...
xgboost.train(
    params, dtrain, num_boost_round=10, *, evals=None, obj=None, maximize=None, early_stopping_rounds=None,
...
lightgbm.train(
    params, train_set, num_boost_round=100, valid_sets=None, valid_names=None, feval=None, init_model=None,
...
lightgbm.LGBMClassifier(
    *, boosting_type='gbdt', num_leaves=31, max_depth=-1, learning_rate=0.1, n_estimators=100,
    ...
    reg_lambda=0.0, random_state=None, n_jobs=None, importance_type='split', **kwargs)
```
...
针对 [scikit-learn](https://scikit-learn.org/)，[XGBoost](https://xgboost.readthedocs.io/)，[LightGBM](https://lightgbm.readthedocs.io/) 和 [CatBoost](https://catboost.ai/) 4 种 GBM 的具体实现，下表汇总了各自的相关特性 ^[<https://leovan.me/cn/2018/12/ensemble-learning/>]：

|                              | scikit-learn   | XGBoost                          | LightGBM  | CatBoost                  |
| ---------------------------- | -------------- | -------------------------------- | --------- | ------------------------- |
| **当前版本** ^[数据截止 2025 年 12 月] | 1.8.0          | 3.1.2                            | 4.6.0     | 1.2.8                     |
| **实现语言**                     | C, C++, Python | C, C++                           | C, C++    | C++                       |
| **API 语言**                   | Python         | Python, R, Java, Scala, C++, ... | Python, R | Python, R                 |
...
|                                   | scikit-learn                     | XGBoost                                                      | LightGBM                                                     | CatBoost                                                     |
| --------------------------------- | -------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Boosting 类型**                 | Gradient Boosted Tree (**GBDT**) | **GBDT** (booster: gbtree) <br/>Generalized Linear Model, **GLM** (booster: gbliner) <br/>Dropout Additive Regression Tree, **DART** (booster: dart) | **GBDT** (boosting: gbdt) <br/>**Random Forest** (boosting: rf) <br/>**DART** (boosting: dart) <br/>Gradient-based One-Side Sampling, **GOSS** (boosting: goss) | **Ordered** (boosting\_type: Ordered) <br/>**Plain** (boosting\_type: Plain) |
...
::: aside
<https://scikit-learn.org/stable/modules/tmp/sklearn.ensemble.StackingClassifier.html>
:::
