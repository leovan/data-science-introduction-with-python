...
::: {.column width="50%"}
![](images/broadcasting-over-axis-0-of-a-2d-array.png){fig-align="center" width=100%}
:::
::::
...
::: {.column width="50%"}
![](images/broadcasting-over-axis-1-of-a-2d-array.png){fig-align="center" width=100%}
:::
::::
...
::: {.center}
![](images/broadcasting-over-axis-0-of-a-3d-array.png){fig-align="center" height=60%}
:::
...
::: {.center}
![](images/compatible-2d-array-shapes-for-broadcasting-over-a-3d-array.png){fig-align="center" width=50%}
:::
...
::: {.column width="50%"}
![](images/indexing-elements-in-a-numpy-array.png){fig-align="center" width=60%}
...
::: {.column width="50%"}
![](images/two-dimensional-array-slicing.png){fig-align="center" width=70%}
:::
::::
...
| ---------------------- | -------------------------------------------- |
| `add`                  | 将数组的对应元素相加                         |
| `subtract`             | 将第一个数组逐元素减去第二个数组中的对应元素 |
| `multiply`             | 将数组逐元素相乘                             |
| `divide, floor_divide` | 除或乘除                                     |
| `power`                | 将第一个数组的元素以其对应的第二个数组元素为次幂进行计算     |
