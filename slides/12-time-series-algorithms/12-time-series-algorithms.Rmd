...
rcParams['font.sans-serif'] = ['Source Han Sans SC']
```
...
dta.plot(ax=ax)
fig.tight_layout()
fig.savefig('generated/sunspots.png', dpi=150)
plt.close(fig)
```

![](generated/sunspots.png)
]
...
fig.tight_layout()
fig.savefig('generated/sunspots-acf.png', dpi=150)
plt.close(fig)
```

![](generated/sunspots-acf.png)
]
...
fig.tight_layout()
fig.savefig('generated/sunspots-pacf.png', dpi=150)
plt.close(fig)
```

![](generated/sunspots-pacf.png)
]
...
.pull-left[
```{python}
arma_mod20 = sm.tsa.ARIMA(dta, order=(2,0,0)).fit()
arma_mod20.params
arma_mod30 = sm.tsa.ARIMA(dta, order=(3,0,0)).fit()
arma_mod30.params
```
]
...
fig.tight_layout()
fig.savefig('generated/sunspots-residual.png', dpi=150)
plt.close(fig)
```

![](generated/sunspots-residual.png)
]
...
fig.tight_layout()
fig.savefig('generated/sunspots-residual-qqplot.png', dpi=150)
plt.close(fig)
```

![](generated/sunspots-residual-qqplot.png)
]
...
fig.tight_layout()
fig.savefig('generated/sunspots-residual-acf.png', dpi=150)
plt.close(fig)
```

![](generated/sunspots-residual-acf.png)
]
...
fig.tight_layout()
fig.savefig('generated/sunspots-residual-pacf.png', dpi=150)
plt.close(fig)
```

![](generated/sunspots-residual-pacf.png)
]
...
plot_predict(arma_mod30, '1990', '2012', dynamic=True, ax=ax, plot_insample=False)
fig.tight_layout()
fig.savefig('generated/sunspots-predict.png', dpi=150)
plt.close(fig)
```

![](generated/sunspots-predict.png)
]
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/co2-seasonal.png', dpi=150)
plt.close(fig)
```

![](generated/co2-seasonal.png)
]
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/peyton-manning-forecast.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/peyton-manning-forecast-components.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/r-forecasting-growth.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/r-saturating-minimum.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/peyton-manning-changepoints.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/peyton-manning-changepoints-increase-trend-flexibility.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/peyton-manning-changepoints-decrease-trend-flexibility.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/peyton-manning-changepoints-specify-locations.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/peyton-manning-holidays-components.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/peyton-manning-country-level-holidays.png', dpi=150)
plt.close(fig)
```
...
plot_yearly(m, ax=ax)
fig.tight_layout()
fig.savefig('generated/peyton-manning-plot-yearly-10.png', dpi=150)
plt.close(fig)
```
...
plot_yearly(m, ax=ax)
fig.tight_layout()
fig.savefig('generated/peyton-manning-plot-yearly-20.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/peyton-manning-custom-seasonalities.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/peyton-manning-conditional-seasonalities.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/peyton-manning-add-regressor.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/air-passengers-numbers-additive-seasonality.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/air-passengers-numbers-multiplicative-seasonality.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/air-passengers-numbers-multiplicative-seasonality-components.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/peyton-manning-uncertainty-intervals.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/r-log-outliers-1.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/r-log-na.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/r-log-outliers-2.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/r-log-outliers-2-fixed.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/yosemite-temps.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/yosemite-temps-components.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/yosemite-temps-0-6-future-all.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/yosemite-temps-0-6-future-0-6.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/retail-sales.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/retail-sales-multiplicative-components.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/retail-sales-multiplicative.png', dpi=150)
plt.close(fig)
```
...
plt.style.use('ggplot')
fig.tight_layout()
fig.savefig('generated/retail-sales-cross-validation-mape.png', dpi=150)
plt.close(fig)
```
