...
dta.plot(ax=ax)
fig.tight_layout()
fig.savefig('tmp/sunspots.png', dpi=150)
plt.close(fig)
```

![](tmp/sunspots.png){fig-align="center" width=100%}
:::
::::
...
fig.tight_layout()
fig.savefig('tmp/sunspots-acf.png', dpi=150)
plt.close(fig)
```

![](tmp/sunspots-acf.png){fig-align="center" width=100%}
:::
...
fig.tight_layout()
fig.savefig('tmp/sunspots-pacf.png', dpi=150)
plt.close(fig)
```

![](tmp/sunspots-pacf.png){fig-align="center" width=100%}
:::
::::
...
fig.tight_layout()
fig.savefig('tmp/sunspots-residual.png', dpi=150)
plt.close(fig)
```

![](tmp/sunspots-residual.png){fig-align="center" width=100%}
:::
...
fig.tight_layout()
fig.savefig('tmp/sunspots-residual-qqplot.png', dpi=150)
plt.close(fig)
```

![](tmp/sunspots-residual-qqplot.png){fig-align="center" width=100%}
:::
::::
...
fig.tight_layout()
fig.savefig('tmp/sunspots-residual-acf.png', dpi=150)
plt.close(fig)
```

![](tmp/sunspots-residual-acf.png){fig-align="center" width=100%}
:::
...
fig.tight_layout()
fig.savefig('tmp/sunspots-residual-pacf.png', dpi=150)
plt.close(fig)
```

![](tmp/sunspots-residual-pacf.png){fig-align="center" width=100%}
:::
::::
...
fig.tight_layout()
fig.savefig('tmp/sunspots-predict.png', dpi=150)
plt.close(fig)
```

![](tmp/sunspots-predict.png){fig-align="center" width=100%}
:::
::::
...
fig.tight_layout()
fig.savefig('tmp/co2-seasonal.png', dpi=150)
plt.close(fig)
```

![](tmp/co2-seasonal.png){fig-align="center" width=100%}
:::
::::
...
fig.tight_layout()
fig.savefig('tmp/peyton-manning-forecast.png', dpi=150)
plt.close(fig)
```
...
fig.tight_layout()
fig.savefig('tmp/peyton-manning-forecast-components.png', dpi=150)
plt.close(fig)
```
...
fig.tight_layout()
fig.savefig('tmp/r-forecasting-growth.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/r-saturating-minimum.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/peyton-manning-changepoints.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/peyton-manning-changepoints-increase-trend-flexibility.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/peyton-manning-changepoints-decrease-trend-flexibility.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/peyton-manning-changepoints-specify-locations.png', dpi=150)
plt.close(fig)
```
...
::: {.column width="50%"}
```{python}
forecast[(forecast['playoff'] + forecast['superbowl']
    ).abs() > 0][['ds', 'playoff', 'superbowl']][-10:]
```
:::
::::
...
fig.set_size_inches(7, 6.5)
fig.tight_layout()
fig.savefig('tmp/peyton-manning-holidays-components.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(7, 6.5)
fig.tight_layout()
fig.savefig('tmp/peyton-manning-country-level-holidays.png', dpi=150)
plt.close(fig)
```
...
plot_yearly(m, ax=ax)
fig.tight_layout()
fig.savefig('tmp/peyton-manning-plot-yearly-10.png', dpi=150)
plt.close(fig)
```
...
增加傅立叶项的个数可以使季节性拟合更快的变化周期，但同时也可能导致过拟合。$N$ 个傅立叶项对应到周期建模中 $2N$ 个变量。
:::
...
plot_yearly(m, ax=ax)
fig.tight_layout()
fig.savefig('tmp/peyton-manning-plot-yearly-20.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(7, 6.5)
fig.tight_layout()
fig.savefig('tmp/peyton-manning-custom-seasonalities.png', dpi=150)
plt.close(fig)
```
...
fig.tight_layout()
fig.savefig('tmp/peyton-manning-conditional-seasonalities.png', dpi=150)
plt.close(fig)
```
...
fig.tight_layout()
fig.savefig('tmp/peyton-manning-add-regressor.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/air-passengers-numbers-additive-seasonality.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/air-passengers-numbers-multiplicative-seasonality.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(7, 6.5)
fig.tight_layout()
fig.savefig('tmp/air-passengers-numbers-multiplicative-seasonality-components.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(7, 6.5)
fig.tight_layout()
fig.savefig('tmp/peyton-manning-uncertainty-intervals.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/r-log-outliers-1.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/r-log-na.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/r-log-outliers-2.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/r-log-outliers-2-fixed.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/yosemite-temps.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/yosemite-temps-components.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/yosemite-temps-0-6-future-all.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/yosemite-temps-0-6-future-0-6.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/retail-sales.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(7, 6.5)
fig.tight_layout()
fig.savefig('tmp/retail-sales-multiplicative-components.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/retail-sales-multiplicative.png', dpi=150)
plt.close(fig)
```
...
fig.set_size_inches(6, 5.6)
fig.tight_layout()
fig.savefig('tmp/retail-sales-cross-validation-mape.png', dpi=150)
plt.close(fig)
```
